...
tb_burden <- read.csv("E:\\Study\\Waterloo\\MSCI718\\Ass2\\TB_burden_countries_2020-02-22.csv")
tb_mdr_rr <- read.csv("E:\\Study\\Waterloo\\MSCI718\\Ass2\\MDR_RR_TB_burden_estimates_2020-02-23.csv")
tb_notif <- read.csv("E:\\Study\\Waterloo\\MSCI718\\Ass2\\TB_notifications_2020-02-23.csv")
```
```{r, include = FALSE, echo = FALSE}
...
Contribution :
Both of us explored the datasets and brainstormed together to get to the final variables. Then, Karan Kohli worked on the coding part of making the data and getting correlation while Rishabh worked on compiling the work into report. 
